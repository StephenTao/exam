$(function() {
    ...
    var appHeight = 24;
    var flashvars = {
        'upload_image' : base + '/WUI/qrecord/images/upload.png'
    };
    var params = {};
    var attributes = {
        'id' : "recorderApp",
    ...
    swfobject.embedSWF(base + "/WUI/qrecord//recorder.swf", "flashcontent", appWidth, appHeight, "11.0.0", "",
        flashvars, params, attributes);

    // Handling FWR events
    // ------------------------------------------------------------------------------------------------

    window.fwr_event_handler = function() {
